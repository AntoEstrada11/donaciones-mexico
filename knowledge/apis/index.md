...
* [POST /api/payments/checkout](payments-checkout.md) - Inicio de cobro alojado (MP / PayPal).
* [Webhooks de pasarela](payments-webhook.md) - MP y PayPal; captura PayPal al retorno.
...
* [POST /api/dev/contacts](dev-contacts.md) - Alta masiva de donantes ficticios (`nuxt dev` solamente).
